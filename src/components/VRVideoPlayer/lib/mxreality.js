...
export class VR {
    constructor(scene, renderer, container, cameraPara, cameraPosition) {
        this.scene = scene;
    ...
    destory = function () {
        ...
        for (var timer in this.timerList) {
            clearInterval(this.timerList[timer]);
        }
        this.destoryed = true;
    }

    init = function (extendsAnimationFrame) {
        var that = this;
        ...
        function slideBar(h) {
            ...
            that.timerList.slideBarAniateTimer = animateTimer;
        }
    ...
    playPanorama = function (recUrl, resType) {
    ...
    sphere2BoxPano = function (img, w, h, callback) {
        var that = this;
        var fases = {
            'x': 'x',
            'nx': 'nx',
